...
from infrastructure.db_pack.db import get_all_open_sell_orders
from infrastructure.db_pack.db import get_all_open_sell_orders_autobuy
...
async def update_result_if_have_order_autobuy(user_id):
    ...
    if len(sorted_records) > 0:
        ...
        result.update(
            {
                "actual_order": sorted_records["order_id_limit"],
